module.exports = [
    {
        ...
        content: [
            ...
            },
            {
                name: 'Copy RSS feed',
                id: 'copy-rss',
                text: 'Find RSS feed of current page and copy it to Clipboard'
            },
            {
                name: 'Open RSS feed',
                id: 'open-rss',
                text: 'Find & open RSS feed of current page in a new tab'
            },
        ]
    },
    {
        ...
        content: [
            {
                name: "Open media",
                id: "openmedia",
                text: "If you are on image or video page, open the media in separate tab. So you can save them or send link to firend"
            }
        ]
    },
    {
